...
export default function PremiumServices() {
  return (
    <section id="servicos" className="py-24 bg-navy-dark relative overflow-hidden">
      {/* Background Decor */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[300px]">
          {services.map((service, index) => (
            <motion.div
              ...
              className={`relative group rounded-[32px] overflow-hidden cursor-pointer border border-white/5 shadow-2xl ${service.size === "large" ? "lg:col-span-2 lg:row-span-2" :
                  ""
                }`}
            >
              <Image
